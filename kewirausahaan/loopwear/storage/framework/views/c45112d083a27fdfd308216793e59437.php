                ...
                <div class="d-flex justify-content-between align-items-center mt-3 pt-2">
                    ...
                    <?php if($order->status_payment == 'pending'): ?>
                        <div class="d-flex gap-2">
                            ...
                            <!-- Tombol Bypass (Simulasi Bayar) untuk Testing -->
                            <form action="<?php echo e(route('pesanan.fakepay', $order->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn btn-info fw-bold text-dark rounded-pill px-3">
                                    ☑️ Simulasi Bayar (Test)
                                </button>
                            </form>
