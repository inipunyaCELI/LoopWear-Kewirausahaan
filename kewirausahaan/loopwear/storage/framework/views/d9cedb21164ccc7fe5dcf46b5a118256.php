        ...
        <div class="col-md-4">
            <div class="card shadow-sm border-0" style="background-color: #FFF24D; border-radius: 20px;">
                <div class="card-body p-4 text-center">
                    ...
                    <h1 class="display-4 fw-bold"><?php echo e($totalBarang); ?></h1>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm border-0" style="background-color: #8CABFF; border-radius: 20px; color: white;">
                <div class="card-body p-4 text-center">
                    ...
                    <h1 class="display-4 fw-bold"><?php echo e($barangTersedia); ?></h1>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm border-0" style="background-color: #FFB6A9; border-radius: 20px; color: white;">
                <div class="card-body p-4 text-center">
                    ...
                    <h1 class="display-4 fw-bold"><?php echo e($totalUser); ?></h1>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER\OneDrive\Documents\Kuliah\Semester 2\Kewirausahaan\LoopWear-Kewirausahaan\kewirausahaan\loopwear\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>