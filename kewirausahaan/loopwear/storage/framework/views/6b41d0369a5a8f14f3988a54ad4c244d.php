...
<div class="search-hero">
    ...
    <p class="search-hero-sub">
        <?php if($items->count() > 0): ?>
            Ditemukan <strong style="color:#47510B;"><?php echo e($items->count()); ?></strong> produk untuk "<?php echo e($query); ?>"
        <?php else: ?>
            Tidak ada produk yang cocok untuk "<?php echo e($query); ?>"
        <?php endif; ?>
    </p>

    
    <form action="<?php echo e(route('search')); ?>" method="GET" class="px-3">
...
<div class="result-info-bar">
    <div class="container d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div class="d-flex align-items-center gap-2">
            <span class="result-count-badge"><?php echo e($items->count()); ?> produk</span>
            <span style="font-size: 0.85rem; color: #666;">
                untuk kata kunci <strong>"<?php echo e($query); ?>"</strong>
            </span>
        </div>
        <a href="<?php echo e(route('user.products')); ?>" style="font-size:0.82rem; color:#47510B; font-weight:700; text-decoration:none;">
            ← Lihat Semua Produk
        </a>
    </div>
</div>
...
<div class="container search-page py-5">
                ...
                <div class="text-center">
                    ...
                    <div class="mb-1" style="min-height: 26px;">
                        <?php if($item->kategori): ?>
                            <span class="product-badge badge-kategori"><?php echo e(ucfirst($item->kategori)); ?></span>
                        <?php endif; ?>
                        <?php if($item->warna): ?>
                            <span class="product-badge badge-warna"><?php echo e(ucfirst($item->warna)); ?></span>
                        <?php endif; ?>
                    </div>
    ...
    <?php else: ?>
        ...
        <div class="empty-state">
            ...
            <p class="empty-sub">
                Kami tidak menemukan produk yang cocok dengan "<strong><?php echo e($query); ?></strong>".
                Coba kata kunci lain, atau jelajahi kategori di bawah ini.
            </p>
            <div class="suggestions">
                <a href="<?php echo e(route('search')); ?>?q=hijab"  class="suggestion-chip">Hijab</a>
                <a href="<?php echo e(route('search')); ?>?q=baju"   class="suggestion-chip">Baju</a>
                <a href="<?php echo e(route('search')); ?>?q=celana" class="suggestion-chip">Celana</a>
                <a href="<?php echo e(route('search')); ?>?q=sepatu" class="suggestion-chip">Sepatu</a>
                <a href="<?php echo e(route('search')); ?>?q=hitam"  class="suggestion-chip">Hitam</a>
                <a href="<?php echo e(route('search')); ?>?q=putih"  class="suggestion-chip">Putih</a>
                <a href="<?php echo e(route('search')); ?>?q=merah"  class="suggestion-chip">Merah</a>
            </div>
            <div class="mt-4">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER\OneDrive\Documents\Kuliah\Semester 2\Kewirausahaan\LoopWear-Kewirausahaan\kewirausahaan\loopwear\resources\views/search.blade.php ENDPATH**/ ?>