    ...
    <div class="row align-items-start">
        ...
        <p class="text-muted mb-4" style="font-size: 0.9rem;">
            <?php if($total_review > 0): ?>
                <?php echo e($rata_rating); ?>

                <span style="color: #F29C9C;">
                    <?php for($i = 1; $i <= 5; $i++): ?>
                        <?php echo $i <= round($rata_rating) ? '★' : '☆'; ?>

                    <?php endfor; ?>
                </span>
                &nbsp;|&nbsp; <?php echo e($total_review); ?> Penilaian
                &nbsp;|&nbsp; <?php echo e($total_terjual); ?> Terjual
            <?php else: ?>
            ...
            <div class="col-6 col-md-3">
                <a href="<?php echo e(route('user.products.detail', $rec->id_barang)); ?>" class="rec-card d-block">
                    <div class="rec-img-wrapper mb-2 shadow-sm">
                        <img src="<?php echo e(asset('images/' . $rec->gambar)); ?>" class="rec-img" alt="<?php echo e($rec->nama_barang); ?>">
                    </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER\OneDrive\Documents\Kuliah\Semester 2\Kewirausahaan\LoopWear-Kewirausahaan\kewirausahaan\loopwear\resources\views/review.blade.php ENDPATH**/ ?>