                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <select name="warna" class="form-select form-control-loop">
                            ...
                            <option value="yellow" <?php echo e($barang->warna == 'yellow' ? 'selected' : ''); ?>>Yellow</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 mb-4 text-center">
                        ...
                        <div class="position-relative d-inline-block mt-2 mb-3">
                            <img src="<?php echo e(asset('images/'.$barang->gambar)); ?>" width="120" class="img-preview-edit shadow-sm" alt="Preview Produk">
                        </div>
