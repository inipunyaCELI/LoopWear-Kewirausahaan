...
<style>
    ...
    .success-card {
        background: #fff;
        border-radius: 24px;
        box-shadow: 0 15px 35px rgba(231, 153, 139, 0.08);
        padding: 50px 40px;
        border: 1px solid rgba(231, 153, 139, 0.15);
        position: relative;
        overflow: hidden;
    }
    ...
    .success-icon-wrapper {
        ...
        transform: scale(0);
        box-shadow: 0 0 0 10px rgba(231, 153, 139, 0.08);
    }
    ...
    .btn-home {
        ...
        box-shadow: 0 4px 15px rgba(231, 153, 139, 0.3);
    }
