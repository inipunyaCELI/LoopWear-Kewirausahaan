...
<div id="searchOverlay" role="dialog" aria-modal="true" aria-label="Pencarian Produk">
    ...
    <div class="search-overlay-inner">
        ...
        <div class="search-tag-group">
            ...
            <a href="{{ route('search') }}?q=hijab" class="search-tag">Hijab</a>
            <a href="{{ route('search') }}?q=baju" class="search-tag">Baju</a>
            <a href="{{ route('search') }}?q=celana" class="search-tag">Celana</a>
            <a href="{{ route('search') }}?q=sepatu" class="search-tag">Sepatu</a>
            <a href="{{ route('search') }}?q=hitam" class="search-tag">Hitam</a>
            <a href="{{ route('search') }}?q=putih" class="search-tag">Putih</a>
            <a href="{{ route('search') }}?q=merah" class="search-tag">Merah</a>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row gy-4">
            ...
            <div class="col-md-3">
                ...
                <a href="https://www.instagram.com/loopwear___?igsh=MTg5eXY1bWlsNjE4Ng%3D%3D&utm_source=qr" target="_blank" style="display: flex; align-items: center; gap: 8px; color: #fff24d; text-decoration: none; font-size: 0.82rem; opacity: 0.85; margin-bottom: 8px;">
        ...
        <p style="text-align: center; font-size: 0.78rem; color: #fff24d; opacity: 0.7; margin: 0;">
            © 2026 LoopWear. All rights reserved. Made with 💛 in Banjarmasin.
        </p>
    </div>
</footer>
