        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-3">
                <input type="email" name="email" class="form-control" placeholder="Email kamu" required
                       style="border-radius:10px; padding:12px; font-family:'Quicksand',sans-serif;">
            ...
            <div class="mb-3">
                <input type="password" name="password" class="form-control" placeholder="Password baru" required
                       style="border-radius:10px; padding:12px; font-family:'Quicksand',sans-serif;">
                @error('password') <div style="color:red; font-size:0.8rem; margin-top:4px;">{{ $message }}</div> @enderror
            </div>
