    ...
    <div class="promo-banner-main shadow-sm">
        <div class="row w-100 align-items-center m-0">
            ...
            <div class="col-md-6 position-static">
                <img src="{{ asset('images/baju.png') }}" class="promo-img" alt="Promo Model">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row g-4">
            ...
            <div class="col-6 col-md-3">
                <div class="product-grid-card">
                    <div class="product-img-box">
                        ...
                        <img src="{{ asset('images/hijab_pink.png') }}" class="grid-img" alt="Pashmina">
                    </div>
            ...
            <div class="col-6 col-md-3">
                <div class="product-grid-card">
                    <div class="product-img-box">
                        <button class="btn-wishlist-grid"><i class="far fa-heart"></i></button>
                        <img src="{{ asset('images/baju.png') }}" class="grid-img" alt="Baju">
                    </div>
                    <div class="product-info mb-3 px-1">
            ...
            <div class="col-6 col-md-3">
                <div class="product-grid-card">
                    <div class="product-img-box">
                        <button class="btn-wishlist-grid"><i class="far fa-heart"></i></button>
                        <img src="{{ asset('images/celana.png') }}" class="grid-img" alt="Celana">
                    </div>
                    <div class="product-info mb-3 px-1">
            ...
            <div class="col-6 col-md-3">
                <div class="product-grid-card">
                    <div class="product-img-box">
                        <button class="btn-wishlist-grid"><i class="far fa-heart"></i></button>
                        <img src="{{ asset('images/sepatu.png') }}" class="grid-img" alt="Sepatu">
                    </div>
                    <div class="product-info mb-3 px-1">
    ...
    <div class="row g-4">
        ...
        <div class="col-6 col-md-3">
            <div class="product-grid-card">
                <div class="product-img-box">
                    <button class="btn-wishlist-grid"><i class="far fa-heart"></i></button>
                    <img src="{{ asset('images/baju.png') }}" class="grid-img" alt="Cardigan">
                </div>
                <div class="product-info mb-3 px-1">
                    <div class="product-brand">UNIQLO</div>
                    <div class="product-name">Ribbed Cropped Cardigan LILAC</div>
        ...
        <div class="col-6 col-md-3">
            <div class="product-grid-card">
                <div class="product-img-box">
                    <button class="btn-wishlist-grid"><i class="far fa-heart"></i></button>
                    <img src="{{ asset('images/celana.png') }}" class="grid-img" alt="Kulot">
                </div>
                <div class="product-info mb-3 px-1">
                    <div class="product-brand">ZARA</div>
        ...
        <div class="col-6 col-md-3">
            <div class="product-grid-card">
                <div class="product-img-box">
                    <button class="btn-wishlist-grid"><i class="far fa-heart"></i></button>
                    <img src="{{ asset('images/sepatu.png') }}" class="grid-img" alt="Sneakers">
                </div>
                <div class="product-info mb-3 px-1">
